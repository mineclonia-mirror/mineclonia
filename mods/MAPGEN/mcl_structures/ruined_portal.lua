...
local def = {
	...
	after_place = function(pos, _, pr)
		...
		core.bulk_swap_node(get_replacements(gold,30,pr),{name="air"})
		core.bulk_swap_node(get_replacements(lava,20,pr),{name="mcl_nether:magma"})
		core.bulk_swap_node(get_replacements(rack,7,pr),{name="mcl_nether:magma"})
		core.bulk_swap_node(get_replacements(obby,15,pr),{name="mcl_core:crying_obsidian"})
		core.bulk_swap_node(get_replacements(obby,10,pr),{name="air"})
		core.bulk_swap_node(get_replacements(brick,50,pr),{name="mcl_core:stonebrickcracked"})
		brick = core.find_nodes_in_area(p1,p2,{"mcl_core:stonebrick"})
		core.bulk_swap_node(get_replacements(brick,50,pr),{name="mcl_core:stonebrickmossy"})
	end,
	loot = {
